...
const displayCategoryItems = (items) => {
    ...
    items.forEach((element) => {
        const postDetails = element.details.slice(0, 500);
        ...
        card.innerHTML = `
                    ...
                    <div class="flex flex-col p-2 lg:p-5 leading-normal">
                        ...
                        <p class="mb-3 font-normal text-gray-700 dark:text-blue-400">
                            ${postDetails}...
                        </p>
                        <div class="grid sm:grid-cols-2 md:grid-cols-3 mx-auto">
                            ...
                            <div class="ml-auto py-4 lg:mr-12 text-2xl">
                                ...
                                onclick='showDetails("${element._id}")'
                                 class=" bg-blue-200 hover:bg-blue-300 px-4 rounded"><i class="fa-solid fa-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
